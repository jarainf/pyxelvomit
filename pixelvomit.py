            ...
            # Meat of the thing
                ...
                if data_split[2]:
                    ...
                    if alpha and len(data_split[2]) > 6:
                        ...
                        # receive data.
                        if da_mode:
                            match len(data_split[2]):
                                case 6:
                                    vbuffer[coordinates:coordinates + 3] = bytes.fromhex(data_split[2])[::-1]
                                case 5:
                                    vbuffer[coordinates:coordinates + 3] = bytes.fromhex(f'0{data_split[2]}')[::-1]
                                case 4:
                                    vbuffer[coordinates:coordinates + 3] = bytes.fromhex(f'00{data_split[2]}')[::-1]
                                case 3:
                                    vbuffer[coordinates:coordinates + 3] = bytes.fromhex(f'000{data_split[2]}')[::-1]
                                case 2:
                                    vbuffer[coordinates:coordinates + 3] = bytes.fromhex(f'{data_split[2]}0000')
                                case 1:
